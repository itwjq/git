...
function add_assets_to_head() {
	...
	echo '<link rel="stylesheet" href="'.PROJECT_CREATOR_URL . '/assets/css/1.css"></link>';
}
...
function add_assets_to_footer(){
	...
	echo '<script src="'.PROJECT_CREATOR_URL . '/assets/js/1.js"></script>';
...
function create_project(){
	//如果有POST变量
	if($_POST){
		require PROJECT_CREATOR_PATH . '/submit_post.php';
		exit;
	}
	require PROJECT_CREATOR_PATH . '/create_project.php';
}
