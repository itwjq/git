		...
		<div class="ur-form-row">
			<div class="ur-form-grid">
				...
				<p class="user-registration-form-row user-registration-form-row--first form-row form-row-first">
					<label for="account_first_name"><?php _e( '姓', 'user-registration' ); ?> <span class="required">*</span></label>
				...
				<p class="user-registration-form-row user-registration-form-row--last form-row form-row-last">
					<label for="account_last_name"><?php _e( '名', 'user-registration' ); ?> <span class="required">*</span></label>
				...
				<p class="user-registration-form-row user-registration-form-row--wide form-row form-row-wide">
					<label for="account_email"><?php _e( '电子邮件', 'user-registration' ); ?> <span class="required">*</span></label>
				...
				<fieldset>
					<legend><?php _e( '更改密码', 'user-registration' ); ?></legend>
					...
					<p class="user-registration-form-row user-registration-form-row--wide form-row form-row-wide">
						<label for="password_2"><?php _e( '确定新密码', 'user-registration' ); ?></label>
				...
				<p>
					...
					<input type="submit" class="user-registration-Button button" name="save_account_details" value="<?php esc_attr_e( '保持更改', 'user-registration' ); ?>" />
