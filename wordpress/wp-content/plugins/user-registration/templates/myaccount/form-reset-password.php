		...
		<div class="ur-form-row">
			<div class="ur-form-grid">
				...
				<p class="user-registration-form-row user-registration-form-row--first form-row form-row-first">
					<label for="password_1"><?php _e( '新的密码', 'user-registration' ); ?> <span class="required">*</span></label>
				...
				<p class="user-registration-form-row user-registration-form-row--last form-row form-row-last">
					<label for="password_2"><?php _e( '重新输入新密码', 'user-registration' ); ?> <span class="required">*</span></label>
				...
				<p class="user-registration-form-row form-row">
					...
					<input type="submit" class="user-registration-Button button" value="<?php esc_attr_e( '保存', 'user-registration' ); ?>" />
				</p>
