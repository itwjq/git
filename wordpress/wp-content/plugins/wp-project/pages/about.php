<div class="wrap">
	...
	<h3>Developer</h3>
	<p>WP-Project is the work of Nick Ohrn, owner of and lead developer for <a href="http://www.plugin-developer.com">Plugin-Developer.com</a>, your one
	stop for custom WordPress plugin development.  If you need a plugin developed, please 
	<a href="http://www.plugin-developer.com/quote">Request a Quote</a>.  You can also <a href="<?php echo $this->friendly_page_link( 'donate' ); ?>">donate</a>
	to keep development of this plugin and other open source plugins by Nick Ohrn active.</p>
</div>