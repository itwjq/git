				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<aside class="post">
						...
						<div class="portfolio-info">
							...
							<!-- 后加内容 -->
							<div class="btn-wrap" style="position: absolute;left:-344px;top:262px;">
								<div class="services_more_btn">
									<?php if($current_options['project_link_btn']!='') {?>
									<a href="<?php echo esc_url($current_options['project_link_btn']); ?>">
								   <?php } if($current_options['project_button_value']!='') { 
								   echo esc_html($current_options['project_button_value']); ?></a>
								   <?php } ?>	
								</div>
							</div>		
						</div>					
