...
function theme_setup_data()
{
		...
		return $busiprof_theme_options = array(
			...
			'protfolio_tag_line'=> __('Raspberry_PI','busiprof'),
			...
			// 后加的link
			'enable_link' => 'on',
			'link_tag_line'=> __('特色项目','busiprof'),
			...
			'service_readmore_button'=>__('更多项目','busiprof'),
			'service_readmore_link'=>'#',
			
			
			
			'service_heading_one' =>__('项目服务','busiprof'),//Service Heading One
			...
			// 后加内容主页面跳转
			'service_link_btn' => 'http://127.0.0.1/wordpress/project-show/',//More Button Link
			'service_button_value' => __('更多项目','busiprof'),
			...
			'project_link_btn' => 'http://127.0.0.1/wordpress/project-pingtai/',//More Button Link
			'project_button_value' => __('更多项目','busiprof'),

			
			
			//主页四个链接
			'link_title_one' => __('浏览项目教程>','busiprof'), //project title one
			'link_thumb_one' =>$template_uri .'/rec_project.jpg', //project thumbnail one
			'link_text_one'  => __('寻找灵感，并学习如何建立自己的互联网连接电子','busiprof'), //project text-description one
			'link_one_url' => '#',
			
			'link_title_two' => __('输入设计挑战>','busiprof'), //project title two
			'link_thumb_two' =>$template_uri .'/rec_project2.jpg', //project thumbnail two
			'link_text_two'  => __('通过设计挑战测试您的技能，有机会赢得大奖','busiprof'), //project text-description two
			'link_two_url' => '#',
			
			'link_title_three' => __('加入现场活动和网络研讨会>','busiprof'), //project title three
			'link_thumb_three' =>$template_uri .'/rec_project3.jpg', //project thumbnail three
			'link_text_three'  => __('学习通过在线或在当地参加研讨会来构建电子产品','busiprof'), //project text-description three
			'link_three_url' => '#',
			
			'link_title_four' => __('关注主题和平台>','busiprof'), //project title three
			'link_thumb_four' =>$template_uri .'/rec_project4.jpg', //project thumbnail three
			'link_text_four'  => __('随时关注您最喜爱的主题和平台，并与社区联系','busiprof'), //project text-description three
			'link_four_url' => '#',
