...
$busiprof_service1_content  = get_theme_mod( 'busiprof_service1_content', $default_content );

if(!empty($current_options)){
if(empty($busiprof_service1_content)){
 ...
 */
function busiprof_service1_content( $busiprof_service1_content, $is_callback = false ) {
	if ( ! $is_callback ) { ?>
